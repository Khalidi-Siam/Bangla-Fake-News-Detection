...
class BertFineTune:
    ...
    def initialize_bert_finetuning(self):
        ...
        logging.info(f"  MLflow tracking URI : {settings.mlflow.tracking_uri}")
        logging.info(f"  MLflow experiment   : {settings.mlflow.experiment_name}")

        with mlflow.start_run(run_name=settings.mlflow.run_name) as _run:
